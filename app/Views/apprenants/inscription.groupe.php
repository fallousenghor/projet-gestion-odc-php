    ...
    <div class="container">
        ...
        <form action="?page=apprenant&action=upload-excel" method="POST" enctype="multipart/form-data">
            <div class="form-section">
                ...
                <div class="row">
                    <div>
                        <label for="import_excel">Fichier Excel</label>
                        <input type="file" id="import_excel" name="import_excel" accept=".xlsx" required>
                    </div>
                </div>
            </div>
        ...
        <div class="form-section">
            ...
            <div class="row">
                <div>
                    <a href="?page=apprenant&action=upload-excel&download_template=1" class="btn  bouton">Télécharger le
                        modèle</a>
                </div>
            </div>
        </div>
